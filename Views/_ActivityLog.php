...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
                <div class="mr-1"> 
                    <form action="ActivityLogSearch.php" method="get">
                        <input type="text" name="search" style="margin-right: 5px;" placeholder="Search" class=
                                ...
                                <!-- Dropdown - List -->
                                    <div class="dropdown-menu shadow" aria-labelledby="userDropdown" style="background-color: white; margin-top: 7px; margin-left: -80px;">  
                                        <?php
                                            ...
                                            echo "
                                            <form action='ActivityLog.php' method='get'>
                ...
                <button><a class="colorbutton" href="ActivityLogArchives.php">See Archives</a></button>
                </div>
            </div>
    </div>
</div>
            ...
            <?php
                ...
                */
                ...
                if ($display == 1) {
                    ...
                    echo "<div><h4/>Recent Activity</h4></div>";

                }
                require 'SBAdmin2/includes/actloglist.inc.php';
            ?>
        </div>
    </div>
</div>