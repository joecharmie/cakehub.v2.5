...
<head>
  ...
  <title>Customize | Cake Icing</title>
...
<body>
  ...
  <?php
    if(!isset($_GET['current'])){
      header("Location: 2.php?error=fillingnotselected");
      exit();
  ...
  <div class="row"> 
    ...
    <div class="options col-sm-6 col-md-6 col-lg-6  text-center" >    
        <button class="btn btn-primary w-75 m-1 opt-btns" type="button" id="btn1" >
          Bluberry Icing
          <img src="./imgcIcing/18.png" alt="" class="w-25" srcset="">
        </button>
      
        <button class="btn btn-primary w-75 m-1 opt-btns" type="button" id="btn2" >
          Chocolate Icing
          <img src="./imgcIcing/19.png" alt="" class="w-25" srcset="">
        </button>
      
        <button class="btn btn-primary w-75 m-1 opt-btns" type="button" id="btn3" >
          Strawberry Icing
          <img src="./imgcIcing/20.png" alt="" class="w-25" srcset="">
        </button>    
    ...
    <div class="display col-sm-6 col-md-6 col-lg-6 " >
      <img src="<?php echo $ImgPath;?>" alt="" srcset="" class="w-75 rounded-img" id="displayImg">

      <button class="btn btn-danger w-75 m-1 r-btns"  id="btnR" style="visibility: hidden;">
        Reset
      </button> 
      <form action="4.php" method="get">
        <button class="btn btn-info w-75 m-1 opt-btns"  id="btnS" style="visibility: hidden;" name="current" value="<?php echo $curr;?>" >
          Submit
        </button> 
  ...
  <script src="./js-customize/script-cakeIcing3.js"></script>
